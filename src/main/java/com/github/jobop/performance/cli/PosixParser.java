...
package com.github.jobop.performance.cli;
 ...
 * @version $Revision: 695760 $, $Date: 2008-09-16 01:05:03 -0700 (Tue, 16 Sep
 *          2008) $
 */
public class PosixParser extends Parser {
	 ...
	 * <code>tokens</code> entries and set <code>eatTheRest</code> to false.
	 */
	private void init() {
		eatTheRest = false;
		tokens.clear();
	...
	/**
	 * Add the special token "<b>--</b>" and the current <code>value</code> to
	 * the processed tokens list. Then add all the remaining
	...
	/**
	 * <p>
	 * If an {@link Option} exists for <code>token</code> then add the token to
	 * the processed list.
	 * </p>
	 * 
	 * <p>
	 * If an {@link Option} does not exist and <code>stopAtNonOption</code> is
	 * set then add the remaining tokens to the processed tokens list directly.
	 * </p>
	 * 
	 * @param token
	 *            The current option token
	 * @param stopAtNonOption
	 *            Specifies whether flattening should halt at the first non
	 *            option.
	 */
	 ...
	 * @param stopAtNonOption
	 *            Specifies whether to stop processing at the first non-Option
	 *            encountered.
	 */
